(function($) {
    $.fn.jquizzy = function(settings) {
        ...
        answers = [],
        introFob = '	<div class="intro-container slide-container"><a class="nav-start" href="#">做好觉悟了吗？要开始了。<br/><br/><span><img src="'+config.startImg+'"></span></a></div>	',
